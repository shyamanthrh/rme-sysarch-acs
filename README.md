...
- Memory region starting at PLAT_FREE_MEM_SMMU, flat-mapped as Realm PAS, with PLAT_MEMORY_POOL_SIZE chosen based on PLATFORM_OVERRIDE_SMMU_STRTAB_BITS plus space for other EL3 SMMU allocations.
